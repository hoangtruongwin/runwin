...
# Tải file từ Google Drive (Windows 11)
echo "Đang tải file Windows 11 từ Google Drive..."
gdown --id 1KFcGkkXrCo33hoANd408DRmu7EyDiNYc -O ./win11.zip
